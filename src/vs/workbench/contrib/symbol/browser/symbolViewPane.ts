...
// 	constructor(
// 		private outerLayout: ISymbolLayout,
...
// class SetListViewModeAction extends ViewAction<SymbolViewPane>  {
...
// 	async runInView(_: ServicesAccessor, view: SymbolViewPane): Promise<void> {
...
// class SetTreeViewModeAction extends ViewAction<SymbolViewPane>  {
// 	constructor(menu: Partial<IAction2Options['menu']> = {}) {
// 		super({
...
// abstract class RepositorySortAction extends ViewAction<SymbolViewPane> {
...
// abstract class SetSortKeyAction extends ViewAction<SymbolViewPane>  {
...
// class CollapseAllRepositoriesAction extends ViewAction<SymbolViewPane>  {
...
// class ExpandAllRepositoriesAction extends ViewAction<SymbolViewPane>  {
...
export class SymbolViewPane extends ViewPane {

	private _onDidLayout: Emitter<void>;
	private layoutCache: ISymbolLayout;
