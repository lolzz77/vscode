...
import { SymbolViewPaneContainer } from 'vs/workbench/contrib/symbol/browser/symbolViewPaneContainer';
...
const viewContainer = Registry.as<IViewContainersRegistry>(ViewContainerExtensions.ViewContainersRegistry).registerViewContainer({
	...
	title: localize('Symbol C', "Symbol D"),
	ctorDescriptor: new SyncDescriptor(SymbolViewPaneContainer),
	storageId: 'workbench.symbol.views.state',
	icon: symbolViewIcon,
